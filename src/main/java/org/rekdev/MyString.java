...
public class MyString {
   ...
   * not null and is a MyString object that contains the same values in its myChars array as this
   * object.
   *
  ...
  /**
   * Detects presence of target array in MyString internal array returning the index of the first
   * occurrence of target in MyString internal array.
   *
