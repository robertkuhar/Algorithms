...
public class ContainsTest {
  ...
  public void testRobertsContains() {
    ...
    for (TestCase t : testCases) {
      assertEquals(t.expectedResult, roberts.contains(t.a1, t.a2), t.label);
    }
  }
  ...
  public void testBestContains() {
    ...
    for (TestCase t : testCases) {
      assertEquals(t.expectedResult, best.contains(t.a1, t.a2), t.label);
    }
  }
  ...
  public void testKatesContains() {
    ...
    for (TestCase t : testCases) {
      assertEquals(t.expectedResult, kates.contains(t.a1, t.a2), t.label);
    }
  }
}
